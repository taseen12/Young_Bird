class BookingsController < ApplicationController
  ...
  def new
    ...
    puts check_in_date.class
    puts "aaaaaaaaaaaaaa"

    puts check_out_date.to_date.class
    puts " minus"
    puts (check_out_date.to_date - check_in_date.to_date)
    @room = Room.find(params[:room_id])
  ...
  def booking_params
    params.require(:booking).permit(:name, :address, :email, :contact_no, :price, :check_in_date, :check_out_date)
  end
end
